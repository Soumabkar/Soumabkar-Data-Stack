...
log "=== [4/6] Suppression images === [DÉSACTIVÉ — images conservées]"
# for img in \
...
# done
log "=== [5/6] Nettoyage global (sans images) ==="
# Sans -a : supprime uniquement containers/réseaux/volumes/cache orphelins
# Les images nommées (trinodb, minio, airflow...) sont préservées
docker system prune -f --volumes || true
log "=== [6/6] Suppression dossiers ==="
# Les fichiers trino-config/* appartiennent à root (montés par Docker) — sudo requis
